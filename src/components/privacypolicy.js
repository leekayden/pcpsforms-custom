...
function privacypolicy() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to PCPSForms.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to PCPSForms, accessible from{" "}
            <a
              href="https://pcpsforms.vercel.app"
              rel="noopener noreferrer"
              target="_blank"
            >
              https://pcpsforms.vercel.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: kayden-develop@outlook.sg</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href="https://pcps-forms.vercel.app/contact"
              rel="noopener noreferrer"
              target="_blank"
            >
              https://pcps-forms.vercel.app/contact
            </a>
          </p>
        </li>
      </ul>
