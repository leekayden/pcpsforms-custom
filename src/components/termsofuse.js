...
function termsofuse() {
  return (
    <div>
      <h1><strong>PLEASE NOTE THAT THIS TERMS OF USE IS NOT USED FOR THIS SITE AND IS JUST A TEST COPY.</strong></h1>
      <h2>Website Terms of Use</h2>

      <p>Version 1.0</p>

      <p>
        The PCPSForms website located at https://pcpsforms.vercel.app is a
        copyrighted work belonging to PCPSForms. Certain features of the Site
      ...
      <p>
        ...
        to third-party websites and services. Ads will not be displayed on this site.
        The Site does not have control of third party links displayed.
      </p>
      ...
      <p>
        <strong>Cookies and Web Beacons.</strong> Like any other website, PCPS
        Forms uses cookies. These 'cookies' are used to store information
      ...
      <p>
        ...
        Company should be sent to: https://cloudserve.vercel.app. After the
      ...
      <p>Address: https://cloudserve.vercel.app</p>
      <p>Email: kayden-develop@outlook.sg</p>
    </div>
  );
}
